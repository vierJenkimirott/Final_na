    ...
    <div class="dashboard-wrapper d-flex">
        ...
        <div class="nav-sidebar">
            <ul class="list-unstyled">
                ...
                <li class="p-3 {{ request()->routeIs('student.manual') ? 'active' : ''}}"><a href="{{ route('student.manual') }}" class="text-decoration-none"><img src="{{ asset('images/manual.png') }}" alt=""> Student Violation Manual @if(View::shared('isManualNew')) <span class="badge bg-danger">New</span> @endif</a></li>
            </ul>
        </div>
    </div>
