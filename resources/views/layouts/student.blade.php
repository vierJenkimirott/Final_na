    ...
    <div class="dashboard-wrapper d-flex">
        ...
        <div class="nav-sidebar">
            <ul class="list-unstyled">
                <li class="p-3 {{ request()->routeIs('student.account') ? 'active' : ''}}"><a href="{{ route('student.dashboard') }}" class="text-decoration-none"><img src="{{asset('images/account.png')}}" alt=""> Account</a></li>
